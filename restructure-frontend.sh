...
# --- 3j. Mop-up: residual 'frontend/editor/...' path strings anywhere in the ---
# frontend tree - overwhelmingly comments and nested READMEs the targeted passes
# above didn't cover. 'frontend/editor' is unambiguous, so a blanket rewrite is safe.
MOP_FILES=()
