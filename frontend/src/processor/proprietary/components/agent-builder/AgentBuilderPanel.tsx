...
import { StatusBadge, Tabs, type TabItem } from "@editor/ui";
import {
  type Agent,
  AGENT_STATUS_LABEL,
  AGENT_STATUS_TONE,
} from "@processor/api/agents";
import { ScenariosPanel } from "@processor/components/agent-builder/ScenariosPanel";
import { ToolsPanel } from "@processor/components/agent-builder/ToolsPanel";
import { EvalsPanel } from "@processor/components/agent-builder/EvalsPanel";
import { VersionsPanel } from "@processor/components/agent-builder/VersionsPanel";
